...
/* Register offsets from base address (usually 0x3f0)  */
...
NTSTATUS HwDiskChanged(PDRIVE_INFO DriveInfo, PBOOLEAN DiskChanged);
...
NTSTATUS HwReset(PCONTROLLER_INFO Controller);

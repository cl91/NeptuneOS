...
HwReadWriteData(PCONTROLLER_INFO ControllerInfo,
		...
		UCHAR EndOfTrack, UCHAR Gap3Length, UCHAR DataLength)
/*
 ...
 */
{
    ...
    Buffer[1] =
	(Head << COMMAND_HEAD_NUMBER_SHIFT) | DriveInfo->UnitNumber;
...
HwFormatTrack(PCONTROLLER_INFO ControllerInfo,
	      ...
	      UCHAR Head,
	      UCHAR BytesPerSector,
	      UCHAR SectorsPerTrack, UCHAR Gap3Length, UCHAR FillerPattern)
/*
...
HwConfigure(PCONTROLLER_INFO ControllerInfo,
	    BOOLEAN EIS,
	    BOOLEAN EFIFO, BOOLEAN POLL, UCHAR FIFOTHR, UCHAR PRETRK)
/*
 ...
 */
{
    ...
    Buffer[1] = 0;
    Buffer[2] =
	(EIS * CONFIGURE_EIS) + (EFIFO * CONFIGURE_EFIFO) +
 ...
 */
{
	...
	(PCONTROLLER_INFO) DriveInfo->ControllerInfo;
...
HwReadIdResult(PCONTROLLER_INFO ControllerInfo,
	       PUCHAR CurCylinder, PUCHAR CurHead)
/*
...
HwSpecify(PCONTROLLER_INFO ControllerInfo,
	  UCHAR HeadLoadTime,
	  UCHAR HeadUnloadTime, UCHAR StepRateTime, BOOLEAN NonDma)
/*

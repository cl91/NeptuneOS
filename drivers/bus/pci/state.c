...
PCHAR PciTransitionText[PciMaxObjectState + 1] = {
    "PciNotStarted",	"PciStarted",	      "PciDeleted",
    "PciStopped",	"PciSurpriseRemoved", "PciSynchronizedOperation",
    "PciMaxObjectState"
};

NTSTATUS PnpStateCancelArray[PciMaxObjectState] = {
    STATUS_INVALID_DEVICE_REQUEST, STATUS_FAIL_CHECK, STATUS_INVALID_DEVICE_STATE,
    STATUS_INVALID_DEVICE_STATE,   STATUS_FAIL_CHECK, STATUS_FAIL_CHECK
};
				 ...
				 IN PCI_STATE NewState)
{
    ...
    NTSTATUS Status;
    DPRINT1("PCI Request to begin transition of Extension %p to %s ->", DeviceExtension,

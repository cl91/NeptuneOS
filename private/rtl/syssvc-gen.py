...
SIMPLE_TYPES = ["BOOLEAN", "CHAR", "UCHAR", "SHORT", "USHORT", "LONG", "ULONG", "ULONG64",
                ...
                "ACCESS_MASK", "LCID", "PVOID", "HANDLE", "GLOBAL_HANDLE", "LOCAL_HANDLE",
...
class Service:
    ...
    def __init__(self, server_name, client_name, params, client_only, wdmsvc, nofpu):
        ...
        marshallers = [
            ...
            BufferMarshaller(server_name, buffer_type = "Void64",
                             server_type = "PVOID", client_type = "PVOID",
                             client_marshal_func = "KiServiceMarshalBuffer",
                             client_post_marshal_func = "",
                             client_unmarshal_func = "KiServiceUnmarshalBuffer64",
                             server_marshal_func = "KiServiceMapBuffer",
                             server_post_marshal_func = "KiServiceUnmapBuffer"),
            BufferMarshaller(server_name, buffer_type = "PfnDb",
                             server_type = "PULONG_PTR", client_type = "PULONG_PTR",
                             client_marshal_func = "KiServiceMarshalPfnDb",
                             client_post_marshal_func = "",
                             client_unmarshal_func = "KiServiceUnmarshalPfnDb",
                             server_marshal_func = "KiServiceMapPfnDb",
                             server_post_marshal_func = "KiServiceUnmapBuffer"),
            BufferMarshaller(server_name, buffer_type = "BufferPtrs",
                             server_type = "PPVOID", client_type = "PPVOID",
                             client_marshal_func = "KiServiceMarshalBufferPtrs",
                             client_post_marshal_func = "",
                             client_unmarshal_func = "KiServiceUnmarshalBufferPtrs",
                             server_marshal_func = "KiServiceMapBufferPtrs",
                             server_post_marshal_func = "KiServiceUnmapBuffer"),
            ...
            BufferMarshaller(server_name, buffer_type = "ObjectInformation",
                             ...
                             server_marshal_func = "KiServiceMapBuffer",
                             server_post_marshal_func = "KiServiceUnmapBuffer"),
            BufferMarshaller(server_name, buffer_type = "DirectoryObjectInformation",
                             server_type = "PCHAR", client_type = "POBJECT_DIRECTORY_INFORMATION",
                             client_marshal_func = "IopMarshalDirObjInfo",
                             client_post_marshal_func = "IopFreeMarshaledDirObjInfo",
                             client_unmarshal_func = "IopUnmarshalDirObjInfo",
                             server_marshal_func = "KiServiceMapDirObjInfoBuffer",
                             server_post_marshal_func = "KiServiceUnmapBuffer"),

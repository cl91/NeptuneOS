...
@ stdcall IoGetDeviceObjectPointer(ptr long ptr)
...
@ stdcall IoCreateMutex()
@ stdcall IoAcquireMutex(ptr)
@ stdcall IoReleaseMutex(ptr)
...
@ stdcall MmMapPhysicalMemory(ptr long ptr)
...
@ stdcall KeCancelTimerEx(ptr long)
...
@ stdcall HalRegisterFrameBuffer(ptr long long long long long long long long long long)
@ stdcall HalUnregisterFrameBuffer(ptr)
@ stdcall HalRegisterFrameBufferDamageHandler(ptr)

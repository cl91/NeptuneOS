...
struct POINTER_ALIGNMENT _IO_MUTEX {
...
static inline VOID IoInitializeMutex(IN PIO_MUTEX Mutex,
				     IN MWORD Cap)
{
    assert(Mutex != NULL);
...
extern IO_MUTEX IopX86PortMutex;
...
extern IO_MUTEX IopWorkItemMutex;

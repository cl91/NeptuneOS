...
@ stdcall NtCreateFileA(ptr long ptr ptr long long long ptr long long ptr)
@ stdcall NtOpenFile(ptr long ptr ptr long long)
@ stdcall NtOpenFileA(ptr long ptr ptr long long)
...
@ stdcall NtOpenPort(ptr ptr long)
@ stdcall NtOpenPortA(ptr ptr long)
...
@ stdcall NtGetPlugPlayEvent(long ptr long)
@ stdcall NtTestAlert()

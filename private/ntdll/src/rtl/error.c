 ...
 *  mapping defined.
 */
NTAPI ULONG RtlNtStatusToDosErrorNoTeb(IN NTSTATUS Status)
{
 ...
 *  mapping defined.
 */
NTAPI ULONG RtlNtStatusToDosError(IN NTSTATUS Status)
{
 ...
 */
NTAPI NTSTATUS RtlGetLastNtStatus(VOID)
{
 ...
 */
NTAPI ULONG RtlGetLastWin32Error(VOID)
{
 ...
 *  Nothing.
 */
NTAPI VOID RtlSetLastWin32Error(IN ULONG LastError)
{
 ...
 *  Nothing.
 */
NTAPI VOID RtlSetLastWin32ErrorAndNtStatusFromNtStatus(IN NTSTATUS Status)
{
 ...
 * @unimplemented
 */
NTAPI NTSTATUS RtlMapSecurityErrorToNtStatus(IN ULONG SecurityError)
{
    UNIMPLEMENTED;
 ...
 * @implemented
 */
NTAPI NTSTATUS RtlSetThreadErrorMode(IN ULONG NewMode,

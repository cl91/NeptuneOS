			   ...
			   PRTL_SPLAY_LINKS LinkB)
{
	...
	BOOLEAN RootA = RtlIsRoot(LinkA),
	    LeftA = RtlIsLeftChild(LinkA), LeftB = RtlIsLeftChild(LinkB);
	...
	*LinkA = Tb;
	...
	if (RootA) {
		...
		ASSERT(RtlLeftChild(LinkB) ==
		       (LeftB ? LinkA : RtlLeftChild(&Ta)));
		ASSERT(RtlRightChild(LinkB) ==
		       (LeftB ? RtlRightChild(&Ta) : LinkA));
	    } else {
		// LinkA = D, LinkB = A
		// D A   S.P S.L S.R S   Q.L Q.R
 ...
 * @implemented
 */
NTAPI PRTL_SPLAY_LINKS RtlDelete(PRTL_SPLAY_LINKS Links)
{
 ...
 * @implemented
 */
NTAPI VOID RtlDeleteNoSplay(PRTL_SPLAY_LINKS Links,
 ...
 * @implemented
 */
NTAPI PRTL_SPLAY_LINKS RtlRealPredecessor(PRTL_SPLAY_LINKS Links)
{
 ...
 * @implemented
 */
NTAPI PRTL_SPLAY_LINKS RtlRealSuccessor(PRTL_SPLAY_LINKS Links)
{
    PRTL_SPLAY_LINKS Child;
 ...
 * @implemented
 */
NTAPI PRTL_SPLAY_LINKS RtlSplay(PRTL_SPLAY_LINKS Links)
{
    /*
	...
	if (RtlIsLeftChild(N)) {
		 ...
		 */
		if (RtlLeftChild(P))
		    RtlParent(RtlLeftChild(P)) = P;
		if (RtlLeftChild(G))
		    RtlParent(RtlLeftChild(G)) = G;
 ...
 * @implemented
 */
NTAPI PRTL_SPLAY_LINKS RtlSubtreePredecessor(IN PRTL_SPLAY_LINKS Links)
{
    PRTL_SPLAY_LINKS Child;
 ...
 * @implemented
 */
NTAPI PRTL_SPLAY_LINKS RtlSubtreeSuccessor(IN PRTL_SPLAY_LINKS Links)
{
    PRTL_SPLAY_LINKS Child;

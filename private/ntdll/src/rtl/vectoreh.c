...
static PVOID RtlpAddVectoredHandler(IN ULONG FirstHandler,
					 ...
					 IN PCONTEXT Context)
{
    ...
    return RtlpCallVectoredHandlers(ExceptionRecord,
				    Context, &RtlpVectoredExceptionList);
}
				     ...
				     IN PCONTEXT Context)
{
    ...
    (VOID) RtlpCallVectoredHandlers(ExceptionRecord,
				    Context, &RtlpVectoredContinueList);
}

NTAPI PVOID RtlAddVectoredExceptionHandler(IN ULONG FirstHandler,
					   IN PVECTORED_EXCEPTION_HANDLER VectoredHandler)
{
    /* Call the shared routine */
...
NTAPI PVOID RtlAddVectoredContinueHandler(IN ULONG FirstHandler,
					  IN PVECTORED_EXCEPTION_HANDLER VectoredHandler)
{
    /* Call the shared routine */
    return RtlpAddVectoredHandler(FirstHandler,
...
NTAPI ULONG RtlRemoveVectoredExceptionHandler(IN PVOID VectoredHandlerHandle)
{
    /* Call the shared routine */
...
NTAPI ULONG RtlRemoveVectoredContinueHandler(IN PVOID VectoredHandlerHandle)
{
    /* Call the shared routine */
    return RtlpRemoveVectoredHandler(VectoredHandlerHandle,
				     &RtlpVectoredContinueList);

 ...
 * @implemented
 */
NTAPI PVOID RtlInsertElementGenericTableFullAvl(IN PRTL_AVL_TABLE Table,
						IN PVOID Buffer,
						IN ULONG BufferSize,
 ...
 * @implemented
 */
NTAPI PVOID RtlInsertElementGenericTableAvl(IN PRTL_AVL_TABLE Table,
					    IN PVOID Buffer,
					    IN ULONG BufferSize,
					    OUT PBOOLEAN NewElement OPTIONAL)
{
 ...
 * @implemented
 */
NTAPI PVOID RtlLookupElementGenericTableFullAvl(IN PRTL_AVL_TABLE Table,
						IN PVOID Buffer,
						IN OUT PVOID * NodeOrParent,
						IN OUT TABLE_SEARCH_RESULT *SearchResult)
{
 ...
 * @implemented
 */
NTAPI PVOID RtlLookupElementGenericTableAvl(IN PRTL_AVL_TABLE Table,
					    IN PVOID Buffer)
{
 ...
 * @implemented
 */
NTAPI PVOID RtlEnumerateGenericTableAvl(IN PRTL_AVL_TABLE Table,
					IN BOOLEAN Restart)
{
 ...
 * @implemented
 */
NTAPI PVOID RtlLookupFirstMatchingElementGenericTableAvl(IN PRTL_AVL_TABLE Table,
							 IN PVOID Buffer,
 ...
 * @unimplemented
 */
NTAPI PVOID RtlEnumerateGenericTableWithoutSplayingAvl(IN PRTL_AVL_TABLE Table,
 ...
 * @unimplemented
 */
NTAPI PVOID RtlGetElementGenericTableAvl(IN PRTL_AVL_TABLE Table,
					 IN ULONG I)
{
    UNIMPLEMENTED;
    return NULL;
 ...
 * @implemented
 */
NTAPI BOOLEAN RtlDeleteElementGenericTableAvl(IN PRTL_AVL_TABLE Table,
					      IN PVOID Buffer)
{
	...
	Table->RestartKey = RtlRealPredecessorAvl(Node);

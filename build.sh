...
video/intelgpu/intelgpu.sys video/amdgpu/amdgpu.sys video/nvgpu/nvgpu.sys
video/virtio_gpu/virtio_gpu.sys lib/lnxdrv/lnxdrv.sys linux/build/lnxdrv.elf'
FW_COPY_LIST='rtl_nic/rtl8168* radeon/CAICOS_* radeon/BTC_rlc.bin amdgpu/oland*

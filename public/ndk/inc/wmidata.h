...
} WmiQueryPciDeviceCustomProperty_OUT,
...
typedef struct _WmiQueryTcpConnectionOffloadCurrentConfig_IN {
    MSNdis_WmiMethodHeader Header;
} WmiQueryTcpConnectionOffloadCurrentConfig_IN,
...
} WmiQueryReceiveScaleCapabilities_OUT,
...
typedef struct _WmiQueryReceiveFilterHardwareCapabilities_IN {
    MSNdis_WmiMethodHeader Header;
} WmiQueryReceiveFilterHardwareCapabilities_IN,
...
} WmiQueryReceiveFilterGlobalParameters_OUT,
...
} WmiQueryNICSwitchCurrentCapabilities_OUT,

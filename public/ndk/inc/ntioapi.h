...
#define IO_ERROR_LOG_MESSAGE_LENGTH	USHORT_MAX
#define IO_ERROR_LOG_MESSAGE_HEADER_LENGTH				\
    (sizeof(IO_ERROR_LOG_MESSAGE) - sizeof(IO_ERROR_LOG_PACKET) + sizeof(WCHAR) * 40)
...
NTAPI NTSYSAPI NTSTATUS NtCreateFileA(OUT PHANDLE FileHandle,
				      IN ACCESS_MASK DesiredAccess,
...
NTAPI NTSYSAPI NTSTATUS NtOpenFileA(OUT PHANDLE FileHandle,
				    IN ACCESS_MASK DesiredAccess,
				    IN POBJECT_ATTRIBUTES_ANSI ObjectAttributes,
				    OUT PIO_STATUS_BLOCK IoStatusBlock,
				    IN ULONG ShareAccess,

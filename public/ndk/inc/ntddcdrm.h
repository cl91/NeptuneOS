...
#define IOCTL_CDROM_EXCLUSIVE_ACCESS                    \
    CTL_CODE(IOCTL_CDROM_BASE, 0x0017, METHOD_BUFFERED, \
...
#define IOCTL_CDROM_SEND_OPC_INFORMATION                \
    CTL_CODE(IOCTL_CDROM_BASE, 0x001B, METHOD_BUFFERED, \
	     FILE_READ_ACCESS | FILE_WRITE_ACCESS)
...
#define MINIMUM_CDROM_INQUIRY_SIZE \
    36 // RTL_SIZEOF_THROUGH_FIELD(INQUIRYDATA, ProductRevisionLevel)
#define MAXIMUM_CDROM_INQUIRY_SIZE \
    260 // MAXUCHAR + RTL_SIZEOF_THROUGH_FIELD(INQUIRYDATA, AdditionalLength)

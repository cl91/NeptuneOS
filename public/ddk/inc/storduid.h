...
#define DUID_MATCH_ERROR(_duid_status) ((_duid_status) >= DuidErrorGeneral)
#define DUID_MATCH_SUCCESS(_duid_status) ((_duid_status) < DuidErrorGeneral)
...
FORCEINLINE DUID_MATCH_STATUS CompareStorageDuids(IN PSTORAGE_DEVICE_UNIQUE_IDENTIFIER Duid1,
						  ...
						  IN PSTORAGE_DEVICE_UNIQUE_IDENTIFIER Duid2)
{
	...
	idDesc1 = (PSTORAGE_DEVICE_ID_DESCRIPTOR)((PUCHAR)Duid1 +
						  Duid1->StorageDeviceIdOffset);
	idDesc2 = (PSTORAGE_DEVICE_ID_DESCRIPTOR)((PUCHAR)Duid2 +
						  Duid2->StorageDeviceIdOffset);
	...
	for (idx1 = 0; idx1 < idDesc1->NumberOfIdentifiers; idx1++) {
		...
		for (idx2 = 0; idx2 < idDesc2->NumberOfIdentifiers; idx2++) {
			...
			(memcmp(ident1->Identifier, ident2->Identifier,
	...
	sig1 = (PSTORAGE_DEVICE_LAYOUT_SIGNATURE)((PUCHAR)Duid1 +
						  Duid1->DriveLayoutSignatureOffset);
	sig2 = (PSTORAGE_DEVICE_LAYOUT_SIGNATURE)((PUCHAR)Duid2 +
						  Duid2->DriveLayoutSignatureOffset);

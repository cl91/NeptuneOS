...
#define ACPI_METHOD_SET_ARGUMENT_STRING(Argument, StrData)		\
	...
	RtlCopyMemory((PVOID)&Argument->Data[0], (PUCHAR)StrData,	\
		      Argument->DataLength);				\
    }
...
#define ACPI_METHOD_SET_ARGUMENT_BUFFER(Argument, BuffData, BuffLength)	\
	...
	RtlCopyMemory((PVOID)&Argument->Data[0],			\
		      (PUCHAR)BuffData, Argument->DataLength);		\
    }
...
#define ACPI_ENUM_CHILD_NEXT(Child)					\
    (PACPI_ENUM_CHILD)((PUCHAR)Child + ACPI_ENUM_CHILD_LENGTH_FROM_CHILD(Child))
...
#define IOCTL_ACPI_EVAL_METHOD						\
    CTL_CODE(FILE_DEVICE_ACPI, 1, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_ACPI_ACQUIRE_GLOBAL_LOCK					\
    CTL_CODE(FILE_DEVICE_ACPI, 4, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_ACPI_RELEASE_GLOBAL_LOCK					\
    CTL_CODE(FILE_DEVICE_ACPI, 5, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)

#define IOCTL_ACPI_EVAL_METHOD_EX					\
    CTL_CODE(FILE_DEVICE_ACPI, 6, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)
#define IOCTL_ACPI_ASYNC_EVAL_METHOD_EX					\
    CTL_CODE(FILE_DEVICE_ACPI, 7, METHOD_BUFFERED, FILE_READ_ACCESS | FILE_WRITE_ACCESS)

 ...
 */
NTAPI NTSYSAPI NTSTATUS HalRegisterFrameBuffer(IN PVOID VirtBase,
					       IN SIZE_T Size,
					       IN ULONG Offset,
					       IN ULONG Width,
					       IN ULONG Height,
...
NTAPI NTSYSAPI NTSTATUS HalUnregisterFrameBuffer(IN PVOID VirtBase);

typedef NTAPI VOID (HAL_FRAMEBUFFER_DAMAGE_HANDLER)(IN PVOID VirtBase,
						    IN ULONG StartWidth,
